...
export default function Socials() {
  ...
  return (
    <ul id={"contacts"} className="flex rounded-xl border-0 md:flex-row">
      ...
      <li className="items-center p-1 lg:p-2 text-light dark:text-light hover:text-primaryHover dark:hover:text-primaryHover text-lg lg:text-2xl xl:text-4xl rounded-xl">
        <a
